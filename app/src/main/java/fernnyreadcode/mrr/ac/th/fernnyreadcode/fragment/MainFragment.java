...
import fernnyreadcode.mrr.ac.th.fernnyreadcode.utility.GetAllUser;
...
/**
 * Created by Teacher on 20 มีนาคม 2561.
 */
...
//                    No Space
                    ...
                    try {
                        ...
                        String[] columUserStrings = myConstant.getLoginString();
...
//                            User False
                            MyAlert myAlert = new MyAlert(getActivity());
                            myAlert.myDialog("User False", "No This User in mySQL");
